...
/**
 * Legacy alias for updating normal booking options.
 *
 * @package    bookingextension_agent
 * @copyright  2026 Wunderbyte GmbH <info@wunderbyte.at>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class update_option_normal_task extends update_option_task {
    /** Task name constant. */
    public const TASK_NAME = 'mod_booking.update_option_normal';
    ...
    /**
     * Deep preflight validation for the legacy normal alias.
     *
     * @param array $input
     * @param int $cmid
     * @param int $userid
    ...
    public function preflight(array $input, int $cmid, int $userid): preflight_result_v2 {
        $input['optiontype'] = 'normal';
        unset($input['selflearningcourse'], $input['slot_enabled']);
    ...
    public function execute(array $preparedinput, int $cmid, int $userid): array {
        ...
        unset($preparedinput['selflearningcourse'], $preparedinput['slot_enabled']);
