...
class task_discovery {
     ...
     */
    public static function get_task_instances(string $component = 'mod_booking'): array {
     ...
     */
    public static function get_trigger_provider_instances(string $component = 'mod_booking'): array {
        $providers = [];
