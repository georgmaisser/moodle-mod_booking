    ...
    public function get_schema(): array {
        return [
            ...
            'description' => 'CHANGE settings of the booking activity instance (write): action=update with a changes'
                . ' array, e.g. confirmation mails, cancellation, bookings per user. Read requests belong to'
                . ' mod_booking.list_instance_settings. This skill does NOT list settings: for read requests like'
                . ' "what can I configure" or "show the current settings", call the read-only skill'
                . ' mod_booking.list_instance_settings instead — it returns the field catalog with current values'
