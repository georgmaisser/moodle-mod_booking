...
$string['agent_booking_configure_unknown_field'] = 'Das Feld „{$a}" ist keine konfigurierbare Einstellung der Buchungsaktivität.';
$string['agent_booking_configure_unknown_field_question'] = 'Die Einstellung „{$a}" gibt es für diese Buchungsaktivität nicht. Welche der angebotenen Einstellungen meinen Sie?';
$string['agent_booking_configure_use_list_instance_settings'] = 'Dieser Skill aktualisiert nur Einstellungen der Buchungsinstanz. Um die konfigurierbaren Felder und ihre aktuellen Werte aufzulisten, verwenden Sie den Lese-Skill mod_booking.list_instance_settings.';
...
$string['agent_booking_diagnose_check_activityvisible'] = 'Buchungsaktivität verfügbar';
$string['agent_booking_diagnose_check_banned'] = 'Benutzername nicht gesperrt';
$string['agent_booking_diagnose_check_bookingenabled'] = 'Buchung für diese Aktivität aktiviert';
$string['agent_booking_diagnose_check_capacity'] = 'Freie Plätze';
$string['agent_booking_diagnose_check_conditions'] = 'Buchungsbedingungen';
$string['agent_booking_diagnose_check_enrolment'] = 'Einschreibung im Kurs';
$string['agent_booking_diagnose_check_maxperuser'] = 'Buchungslimit pro Person';
$string['agent_booking_diagnose_check_optionvisible'] = 'Option sichtbar';
$string['agent_booking_diagnose_check_rules'] = 'Auf diese Option angewendete Buchungsregeln';
$string['agent_booking_diagnose_check_status'] = 'Buchungsstatus';
$string['agent_booking_diagnose_context_rules_restricted'] = 'Diese Option schränkt ein, welche Buchungsregeln auf sie angewendet werden: {$a->applied} von {$a->total} Regel(n) greifen.';
...
$string['agent_booking_diagnose_finding_activityvisible_fail'] = 'Die Buchungsaktivität ist derzeit nicht verfügbar.';
$string['agent_booking_diagnose_finding_activityvisible_fail_info'] = 'Die Buchungsaktivität ist derzeit nicht verfügbar: {$a}';
$string['agent_booking_diagnose_finding_activityvisible_ok'] = 'Die Buchungsaktivität ist verfügbar.';
$string['agent_booking_diagnose_finding_banned_fail'] = 'Der Benutzername steht auf der Sperrliste dieser Aktivität.';
$string['agent_booking_diagnose_finding_banned_ok'] = 'Der Benutzername steht nicht auf der Sperrliste.';
$string['agent_booking_diagnose_finding_bookingenabled_fail'] = 'Buchung ist für die gesamte Aktivität abgeschaltet.';
$string['agent_booking_diagnose_finding_bookingenabled_ok'] = 'Buchung ist aktiviert.';
$string['agent_booking_diagnose_finding_capacity_full'] = 'Ausgebucht, und es ist keine Warteliste eingerichtet.';
$string['agent_booking_diagnose_finding_capacity_ok'] = 'Es sind Plätze frei.';
$string['agent_booking_diagnose_finding_capacity_waitinglist_available'] = 'Ausgebucht, aber auf der Warteliste ist noch Platz.';
$string['agent_booking_diagnose_finding_capacity_waitinglist_full'] = 'Ausgebucht, und die Warteliste ist ebenfalls voll.';
$string['agent_booking_diagnose_finding_conditions_fail'] = '{$a} Bedingung(en) blockieren diese Buchung.';
$string['agent_booking_diagnose_finding_conditions_ok'] = 'Keine Bedingung blockiert diese Buchung.';
$string['agent_booking_diagnose_finding_enrolment_fail'] = 'Nicht im Kurs eingeschrieben.';
$string['agent_booking_diagnose_finding_enrolment_ok'] = 'Im Kurs eingeschrieben.';
$string['agent_booking_diagnose_finding_maxperuser_fail'] = 'Limit erreicht: {$a->current} von {$a->max} Buchungen verbraucht.';
$string['agent_booking_diagnose_finding_maxperuser_none'] = 'Kein Limit konfiguriert.';
$string['agent_booking_diagnose_finding_maxperuser_ok'] = '{$a->current} von {$a->max} Buchungen verbraucht.';
$string['agent_booking_diagnose_finding_optionvisible_hidden'] = 'Die Option ist verborgen und ohne zusätzliche Rechte nicht buchbar.';
$string['agent_booking_diagnose_finding_optionvisible_notinlist'] = 'Die Option wird nicht in der Liste angezeigt, ist aber über einen Direktlink erreichbar.';
$string['agent_booking_diagnose_finding_optionvisible_ok'] = 'Die Option ist sichtbar.';
$string['agent_booking_diagnose_finding_rules_confirmation_off'] = 'Nur {$a->applied} von {$a->total} Regel(n) greifen. Davon abgeschaltet: {$a->names}.';
$string['agent_booking_diagnose_finding_rules_ok'] = 'Alle {$a} Regel(n) dieses Kontexts greifen.';
$string['agent_booking_diagnose_finding_rules_restricted'] = 'Nur {$a->applied} von {$a->total} Regel(n) greifen, alle Buchungsbestätigungs-Regeln sind aber dabei.';
$string['agent_booking_diagnose_finding_status_booked'] = 'Gebucht.';
$string['agent_booking_diagnose_finding_status_notbooked'] = 'Nicht gebucht.';
$string['agent_booking_diagnose_finding_status_notifylist'] = 'Nur auf der Benachrichtigungsliste, nicht gebucht.';
$string['agent_booking_diagnose_finding_status_reserved'] = 'Reserviert, noch nicht bestätigt.';
$string['agent_booking_diagnose_finding_status_waitinglist'] = 'Auf der Warteliste.';
...
$string['agent_booking_diagnose_reason_rules_mail_skipped'] = 'Die Regel-Einstellung dieser Option hat die Regel(n) abgeschaltet, die Ihnen die Mail geschickt hätte(n): {$a}.';
$string['agent_booking_diagnose_reason_rules_mail_skipped_concrete'] = 'Konkrete Einstellung: in den Einstellungen der Option, Abschnitt "Regeln", steht "{$a->setting}" auf "{$a->mode}". Admin-Aktion: die genannte(n) Regel(n) dort in die Auswahl aufnehmen oder die Einstellung so ändern, dass die Regeln wieder greifen.';
$string['agent_booking_diagnose_reason_rules_mail_skipped_other'] = 'Die Regel-Einstellung dieser Option hat die Regel(n) abgeschaltet, die der ausgewählten Person die Mail geschickt hätte(n): {$a}.';
$string['agent_booking_diagnose_reason_rules_othermail_skipped'] = 'Die Regel-Einstellung dieser Option hat außerdem {$a} weitere Mail-Regel(n) abgeschaltet, von denen aber keine auf eine Buchung reagiert - keine davon hätte eine Buchungsbestätigung verschickt.';
...
$string['agent_booking_diagnose_rules_more'] = 'und {$a} weitere';
...
$string['agent_booking_location_entity_ambiguous'] = 'Mehrere Orte dieser Website passen zu „{$a}".';
$string['agent_booking_location_entity_not_found'] = 'Der Ort „{$a}" ist keiner der auf dieser Website angelegten Orte (Entities).';
$string['agent_booking_location_entity_question'] = 'Welcher der vorhandenen Orte soll für „{$a}" verwendet werden?';
$string['agent_booking_missing_target_activity'] = 'Diese Aktion braucht eine Ziel-Buchungsaktivität. Bitte sagen Sie mir, für welche Buchungsaktivität (und welchen Kurs) sie gelten soll.';
$string['agent_booking_no_instance_facts'] = '(cmid: {$a->cmid}, Optionen: {$a->options})';
...
$string['agent_booking_no_instance_totals'] = 'Insgesamt sehen Sie {$a->options} Buchungsoptionen in {$a->instances} Buchungsaktivitäten.';
...
$string['agent_booking_option_query_notfound_anywhere'] = 'Keine Buchungsoption passt auf „{$a}". Bitte nennen Sie einen anderen Titel — oder sagen Sie mir, in welcher Buchungsaktivität ich suchen soll.';
...
$string['agent_booking_optionfield_capability_required'] = 'Dafür brauchen Sie die Berechtigung, Buchungsoptionsfelder zu verwalten.';
$string['agent_booking_optionfield_created'] = 'Das Buchungsoptionsfeld "{$a}" wurde angelegt.';
$string['agent_booking_optionfield_list_found'] = '{$a} Buchungsoptionsfeld(er) gefunden.';
$string['agent_booking_optionfield_list_one'] = 'Konfiguration des Buchungsoptionsfelds "{$a}".';
$string['agent_booking_optionfield_name_required'] = 'Das Feld braucht einen Anzeigenamen.';
$string['agent_booking_optionfield_not_found'] = 'Es gibt kein Buchungsoptionsfeld "{$a}".';
$string['agent_booking_optionfield_not_found_question'] = 'Ich finde kein Buchungsoptionsfeld "{$a}". Welches vorhandene Feld meinen Sie, oder soll ich es neu anlegen?';
$string['agent_booking_optionfield_select_options_required'] = 'Das Feld "{$a}" ist eine Auswahlliste und braucht daher die auswählbaren Werte. Welche Werte sollen zur Verfügung stehen?';
$string['agent_booking_optionfield_shortname_invalid'] = 'Der Kurzname darf nur Kleinbuchstaben, Ziffern und Unterstriche enthalten.';
$string['agent_booking_optionfield_shortname_required'] = 'Das Feld braucht einen Kurznamen.';
$string['agent_booking_optionfield_shortname_reserved'] = '"{$a}" ist bereits der Name einer Eigenschaft der Buchungsoption, ein Feld mit diesem Kurznamen würde sie verdecken. Welchen anderen Kurznamen soll das Feld bekommen?';
$string['agent_booking_optionfield_shortname_taken'] = 'Ein Buchungsoptionsfeld mit dem Kurznamen "{$a}" gibt es bereits. Soll dieses geändert werden, oder welchen anderen Kurznamen soll das neue Feld bekommen?';
$string['agent_booking_optionfield_target_required'] = 'Bitte sagen Sie, welches Buchungsoptionsfeld geändert werden soll.';
$string['agent_booking_optionfield_type_required'] = 'Das Feld braucht einen Typ.';
$string['agent_booking_optionfield_type_unknown'] = 'Der Feldtyp "{$a->type}" ist auf dieser Website nicht installiert. Verfügbar sind: {$a->installed}. Welcher davon soll verwendet werden?';
$string['agent_booking_optionfield_updated'] = 'Das Buchungsoptionsfeld "{$a}" wurde geändert.';
...
$string['agent_booking_rules_days_not_applicable'] = 'Die gewählte Vorlage hat kein Modell „Tage vor einem Datum“, die Tagesangabe kann daher nicht übernommen werden. Bitte eine Erinnerungs-Vorlage wählen oder die Tage weglassen.';
...
$string['agent_booking_rules_no_rules_in_context'] = 'Keine Buchungsregeln im aktuellen Kontext gefunden. Nennen Sie die Buchungsaktivität, in der ich suchen soll — oder die genaue Regel-ID.';
...
$string['booking:skill_mod_booking_create_option_field'] = 'KI-Skill: Buchungsoptionsfeld anlegen';
...
$string['booking:skill_mod_booking_list_option_fields'] = 'KI-Skill: Buchungsoptionsfelder anzeigen';
...
$string['booking:skill_mod_booking_update_option_field'] = 'KI-Skill: Buchungsoptionsfeld ändern';
...
$string['previewcfg_allowupdate'] = 'Änderungen an Buchungen erlauben';
$string['previewcfg_bookingpolicy'] = 'Buchungsbedingungen';
$string['previewcfg_cancancelbook'] = 'Stornierung erlauben';
$string['previewcfg_daystonotify'] = 'Tage vor dem Termin für die Benachrichtigung der Teilnehmer:innen';
...
$string['previewcfg_eventtype'] = 'Art des Termins';
$string['previewcfg_intro'] = 'Beschreibung / Einleitung';
$string['previewcfg_maxperuser'] = 'Maximale Buchungen pro Nutzer:in';
$string['previewcfg_name'] = 'Name';
$string['previewcfg_notifyemail'] = 'E-Mail-Adresse für Benachrichtigungen (Teilnehmer:innen)';
$string['previewcfg_notifyemailteachers'] = 'E-Mail-Adresse für Benachrichtigungen (Trainer:innen)';
$string['previewcfg_organizatorname'] = 'Name des Veranstalters';
$string['previewcfg_paginationnum'] = 'Optionen pro Seite';
$string['previewcfg_points'] = 'Punkte';
$string['previewcfg_pollurl'] = 'Umfrage-URL (Teilnehmer:innen)';
...
$string['previewcfg_pollurltext'] = 'Linktext der Umfrage-URL (Teilnehmer:innen)';
...
$string['previewcfg_showinapi'] = 'In der API anzeigen';
$string['previewlabel_active'] = 'Aktiv';
$string['previewlabel_address'] = 'Adresse';
$string['previewlabel_appliesto'] = 'Gilt für';
$string['previewlabel_availabilitywindow'] = 'Verfügbarkeitsfenster';
$string['previewlabel_bookingcloses'] = 'Buchung endet';
$string['previewlabel_bookingopens'] = 'Buchung beginnt';
$string['previewlabel_days'] = 'Tage';
$string['previewlabel_defaultprice'] = 'Standardpreis';
$string['previewlabel_end'] = 'Ende';
$string['previewlabel_fieldcategory'] = 'Kategorie';
$string['previewlabel_fielddefault'] = 'Standardwert';
$string['previewlabel_fieldname'] = 'Feldname';
$string['previewlabel_fieldnewshortname'] = 'Neuer Kurzname';
$string['previewlabel_fieldoptions'] = 'Auswählbare Werte';
$string['previewlabel_fieldrequired'] = 'Pflichtfeld';
$string['previewlabel_fieldshortname'] = 'Kurzname';
$string['previewlabel_fieldtype'] = 'Feldtyp';
$string['previewlabel_fieldunique'] = 'Eindeutige Werte';
$string['previewlabel_identifier'] = 'Kennung';
...
$string['previewlabel_participants'] = 'Teilnehmer:innen';
$string['previewlabel_prices'] = 'Preise';
$string['previewlabel_question'] = 'Frage';
$string['previewlabel_requestedtarget'] = 'Gewünschtes Ziel';
...
$string['previewlabel_sortorder'] = 'Sortierung';
$string['previewlabel_start'] = 'Beginn';
...
$string['previewtitle_bookusers'] = 'Nutzer:innen buchen';
...
$string['previewtitle_createoption'] = 'Buchungsoption anlegen';
$string['previewtitle_createoptionfield'] = 'Buchungsoptionsfeld anlegen';
$string['previewtitle_createrule'] = 'Regel aus Vorlage anlegen';
$string['previewtitle_createslotbooking'] = 'Slot-Buchungsoption anlegen';
$string['previewtitle_updateoption'] = 'Buchungsoption aktualisieren';
$string['previewtitle_updateoptionfield'] = 'Buchungsoptionsfeld ändern';
...
$string['previewvalue_unlimited'] = 'Unbegrenzt';
$string['previewvalue_visible'] = 'Sichtbar';
$string['previewvalue_visiblelink'] = 'Nur über den direkten Link sichtbar';
