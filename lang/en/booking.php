...
$string['agent_booking_bulk_update_no_matches'] = 'No booking options in this instance match "{$a}".';
$string['agent_booking_bulk_update_no_options'] = 'This booking instance has no options to update.';
...
$string['agent_booking_configure_unknown_field'] = 'The field "{$a}" is not a configurable setting of the booking activity.';
$string['agent_booking_configure_unknown_field_question'] = 'The setting "{$a}" does not exist for this booking activity. Which of the offered settings do you mean?';
...
$string['agent_booking_diagnose_check_activityvisible'] = 'Booking activity available';
$string['agent_booking_diagnose_check_banned'] = 'Username not blocked';
$string['agent_booking_diagnose_check_bookingenabled'] = 'Booking enabled for this activity';
$string['agent_booking_diagnose_check_capacity'] = 'Places available';
$string['agent_booking_diagnose_check_conditions'] = 'Booking conditions';
$string['agent_booking_diagnose_check_enrolment'] = 'Course enrolment';
$string['agent_booking_diagnose_check_maxperuser'] = 'Booking limit per person';
$string['agent_booking_diagnose_check_optionvisible'] = 'Option visible';
$string['agent_booking_diagnose_check_rules'] = 'Booking rules applied to this option';
$string['agent_booking_diagnose_check_status'] = 'Booking status';
$string['agent_booking_diagnose_context_rules_restricted'] = 'This option limits which booking rules are applied to it: {$a->applied} of {$a->total} rule(s) apply.';
...
$string['agent_booking_diagnose_finding_activityvisible_fail'] = 'The booking activity is currently not available.';
$string['agent_booking_diagnose_finding_activityvisible_fail_info'] = 'The booking activity is currently not available: {$a}';
$string['agent_booking_diagnose_finding_activityvisible_ok'] = 'The booking activity is available.';
$string['agent_booking_diagnose_finding_banned_fail'] = 'The username is on the blocked list of this activity.';
$string['agent_booking_diagnose_finding_banned_ok'] = 'The username is not on the blocked list.';
$string['agent_booking_diagnose_finding_bookingenabled_fail'] = 'Booking is switched off for the whole activity.';
$string['agent_booking_diagnose_finding_bookingenabled_ok'] = 'Booking is enabled.';
$string['agent_booking_diagnose_finding_capacity_full'] = 'Fully booked, and no waiting list is configured.';
$string['agent_booking_diagnose_finding_capacity_ok'] = 'Places are available.';
$string['agent_booking_diagnose_finding_capacity_waitinglist_available'] = 'Fully booked, but the waiting list still has room.';
$string['agent_booking_diagnose_finding_capacity_waitinglist_full'] = 'Fully booked, and the waiting list is full as well.';
$string['agent_booking_diagnose_finding_conditions_fail'] = '{$a} condition(s) block this booking.';
$string['agent_booking_diagnose_finding_conditions_ok'] = 'No condition blocks this booking.';
$string['agent_booking_diagnose_finding_enrolment_fail'] = 'Not enrolled in the course.';
$string['agent_booking_diagnose_finding_enrolment_ok'] = 'Enrolled in the course.';
$string['agent_booking_diagnose_finding_maxperuser_fail'] = 'Limit reached: {$a->current} of {$a->max} bookings used.';
$string['agent_booking_diagnose_finding_maxperuser_none'] = 'No limit configured.';
$string['agent_booking_diagnose_finding_maxperuser_ok'] = '{$a->current} of {$a->max} bookings used.';
$string['agent_booking_diagnose_finding_optionvisible_hidden'] = 'The option is hidden and cannot be booked without additional rights.';
$string['agent_booking_diagnose_finding_optionvisible_notinlist'] = 'The option is not shown in the list, but can be reached via a direct link.';
$string['agent_booking_diagnose_finding_optionvisible_ok'] = 'The option is visible.';
$string['agent_booking_diagnose_finding_rules_confirmation_off'] = 'Only {$a->applied} of {$a->total} rule(s) apply. Switched off among them: {$a->names}.';
$string['agent_booking_diagnose_finding_rules_ok'] = 'All {$a} rule(s) of this context apply.';
$string['agent_booking_diagnose_finding_rules_restricted'] = 'Only {$a->applied} of {$a->total} rule(s) apply, but every booking confirmation rule is among them.';
$string['agent_booking_diagnose_finding_status_booked'] = 'Booked.';
$string['agent_booking_diagnose_finding_status_notbooked'] = 'Not booked.';
$string['agent_booking_diagnose_finding_status_notifylist'] = 'On the notification list only, not booked.';
$string['agent_booking_diagnose_finding_status_reserved'] = 'Reserved, not yet confirmed.';
$string['agent_booking_diagnose_finding_status_waitinglist'] = 'On the waiting list.';
...
$string['agent_booking_diagnose_reason_rules_mail_skipped'] = 'The rule setting of this option switched off the rule(s) that would have sent you the mail: {$a}.';
$string['agent_booking_diagnose_reason_rules_mail_skipped_concrete'] = 'Concrete setting: in the option settings, section "Rules", "{$a->setting}" is set to "{$a->mode}". Admin action: add the listed rule(s) to the selection there, or change the setting so that the rules apply again.';
$string['agent_booking_diagnose_reason_rules_mail_skipped_other'] = 'The rule setting of this option switched off the rule(s) that would have sent the selected user the mail: {$a}.';
$string['agent_booking_diagnose_reason_rules_othermail_skipped'] = 'The rule setting of this option also switched off {$a} other mail rule(s), but none of them reacts to a booking, so none of them would have sent a booking confirmation.';
...
$string['agent_booking_diagnose_rules_more'] = 'and {$a} more';
...
$string['agent_booking_location_entity_ambiguous'] = 'Several locations of this site match "{$a}".';
$string['agent_booking_location_entity_not_found'] = 'The location "{$a}" is none of the locations (entities) of this site.';
$string['agent_booking_location_entity_question'] = 'Which of the existing locations should be used for "{$a}"?';
$string['agent_booking_missing_target_activity'] = 'This action needs a target booking activity. Please tell me which booking activity (and course) it applies to.';
$string['agent_booking_no_instance_facts'] = '(cmid: {$a->cmid}, options: {$a->options})';
...
$string['agent_booking_no_instance_totals'] = 'In total you can see {$a->options} booking options in {$a->instances} booking activities.';
...
$string['agent_booking_option_query_notfound_anywhere'] = 'No booking option matched "{$a}" in any booking activity. Please give a different option title - or tell me which booking activity to look in.';
...
$string['agent_booking_optionfield_capability_required'] = 'You need the permission to manage booking option fields for this.';
$string['agent_booking_optionfield_created'] = 'The booking option field "{$a}" was created.';
$string['agent_booking_optionfield_list_found'] = '{$a} booking option field(s) found.';
$string['agent_booking_optionfield_list_one'] = 'Configuration of the booking option field "{$a}".';
$string['agent_booking_optionfield_name_required'] = 'The field needs a display name.';
$string['agent_booking_optionfield_not_found'] = 'There is no booking option field "{$a}".';
$string['agent_booking_optionfield_not_found_question'] = 'I cannot find a booking option field "{$a}". Which existing field do you mean, or should I create it as a new one?';
$string['agent_booking_optionfield_select_options_required'] = 'The field "{$a}" is a selection list, so it needs the values that can be selected. Which values should be available?';
$string['agent_booking_optionfield_shortname_invalid'] = 'The shortname may only contain lowercase letters, digits and underscores.';
$string['agent_booking_optionfield_shortname_required'] = 'The field needs a shortname.';
$string['agent_booking_optionfield_shortname_reserved'] = '"{$a}" is already the name of a booking option property, so a field with this shortname would hide it. Which other shortname should the field get?';
$string['agent_booking_optionfield_shortname_taken'] = 'A booking option field with the shortname "{$a}" already exists. Should it be changed instead, or which other shortname should the new field get?';
$string['agent_booking_optionfield_target_required'] = 'Please say which booking option field should be changed.';
$string['agent_booking_optionfield_type_required'] = 'The field needs a type.';
$string['agent_booking_optionfield_type_unknown'] = 'The field type "{$a->type}" is not installed on this site. Available are: {$a->installed}. Which of them should be used?';
$string['agent_booking_optionfield_updated'] = 'The booking option field "{$a}" was changed.';
...
$string['agent_booking_rules_days_not_applicable'] = 'The selected template has no "days before a date" model, so the number of days cannot be applied. Choose a reminder template or leave the days out.';
...
$string['agent_booking_rules_no_rules_in_context'] = 'No booking rules found in the current context. Name the booking activity I should look in - or give the exact rule id.';
...
$string['booking:skill_mod_booking_create_option_field'] = 'AI skill: create a booking option field';
...
$string['booking:skill_mod_booking_list_option_fields'] = 'AI skill: show the booking option fields';
...
$string['booking:skill_mod_booking_update_option_field'] = 'AI skill: change a booking option field';
...
$string['previewlabel_days'] = 'Days';
$string['previewlabel_defaultprice'] = 'Default price';
$string['previewlabel_end'] = 'End';
$string['previewlabel_fieldcategory'] = 'Category';
$string['previewlabel_fielddefault'] = 'Default value';
$string['previewlabel_fieldname'] = 'Field name';
$string['previewlabel_fieldnewshortname'] = 'New shortname';
$string['previewlabel_fieldoptions'] = 'Selectable values';
$string['previewlabel_fieldrequired'] = 'Required';
$string['previewlabel_fieldshortname'] = 'Shortname';
$string['previewlabel_fieldtype'] = 'Field type';
$string['previewlabel_fieldunique'] = 'Unique values';
...
$string['previewlabel_matchcount'] = 'Matching options';
...
$string['previewtitle_createoptionfield'] = 'Create booking option field';
...
$string['previewtitle_updateoptionfield'] = 'Change booking option field';
...
$string['previewvalue_unlimited'] = 'Unlimited';
