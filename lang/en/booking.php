...
$string['aiinitialprompt_tool_call_parse_desc'] = 'Prompt template used for compact planning turns (for example first pass/tool-call parsing). Keep it short to reduce token usage. If empty, the global AI initial system prompt is used.';
$string['aiinitialprompt_simple_retrieval'] = 'AI initial prompt (simple retrieval, compact)';
$string['aiinitialprompt_simple_retrieval_desc'] = 'Prompt template used for iterative retrieval turns with prior observations. Keep it compact. If empty, the global AI initial system prompt is used.';
$string['aiinitialprompt_final_reasoning'] = 'AI initial prompt (final reasoning)';
$string['aiinitialprompt_final_reasoning_desc'] = 'Prompt template used for final narration/reasoning turns. This can be richer than compact retrieval prompts. If empty, the global AI initial system prompt is used.';
