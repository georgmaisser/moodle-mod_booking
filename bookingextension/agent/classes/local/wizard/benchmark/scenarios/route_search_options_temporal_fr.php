...
/**
 * Routing scenario: Vague temporal browse (fr) -> search_options with EMPTY query, never query=bientot (F57a)
 *
 * @package    bookingextension_agent
 * @copyright  2026 Wunderbyte GmbH <info@wunderbyte.at>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class route_search_options_temporal_fr extends abstract_routing_scenario {
    /**
    ...
    public function get_key(): string {
        return 'route_search_options_temporal_fr';
    }
    ...
    public function get_description(): string {
        return 'Vague temporal browse (fr) -> search_options with EMPTY query, never query=bientot (F57a)';
    }
    ...
    public function get_user_message(): string {
        return "Qu'est-ce qui arrive bientôt qu'on peut réserver ici ?";
    }
