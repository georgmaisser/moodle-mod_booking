...
/**
 * Routing scenario: Cannot ACCESS/see/open a course -> diagnose_access
 *
 * @package    bookingextension_agent
 * @copyright  2026 Wunderbyte GmbH <info@wunderbyte.at>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class route_diagnose_access_de extends abstract_routing_scenario {
    /**
    ...
    public function get_key(): string {
        return 'route_diagnose_access_de';
    }
    ...
    public function get_description(): string {
        return 'Cannot ACCESS/see/open a course -> diagnose_access';
    }
    ...
    public function get_user_message(): string {
        return 'Warum kann Tom Mueller den Kurs "Biologie 101" nicht oeffnen?';
    }
