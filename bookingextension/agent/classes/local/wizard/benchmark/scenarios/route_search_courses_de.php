...
/**
 * Routing scenario: Resolve a Moodle COURSE container -> course.search_courses (not option search)
 *
 * @package    bookingextension_agent
 * @copyright  2026 Wunderbyte GmbH <info@wunderbyte.at>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class route_search_courses_de extends abstract_routing_scenario {
    /**
    ...
    public function get_key(): string {
        return 'route_search_courses_de';
    }
    ...
    public function get_description(): string {
        return 'Resolve a Moodle COURSE container -> course.search_courses (not option search)';
    }
    ...
    public function get_user_message(): string {
        return 'Finde den Moodle-Kurs "Biologie 101" und gib mir die Kurs-ID.';
    }
