...
/**
 * Routing scenario: Roles/capabilities (may X do Y) -> diagnose_permissions (not access, not notifications)
 *
 * @package    bookingextension_agent
 * @copyright  2026 Wunderbyte GmbH <info@wunderbyte.at>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class route_diagnose_permissions_de extends abstract_routing_scenario {
    /**
    ...
    public function get_key(): string {
        return 'route_diagnose_permissions_de';
    }
    ...
    public function get_description(): string {
        return 'Roles/capabilities (may X do Y) -> diagnose_permissions (not access, not notifications)';
    }
    ...
    public function get_expected_skill(): string {
        return 'core.diagnose_permissions';
    }
