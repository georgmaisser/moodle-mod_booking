...
/**
 * Routing scenario: Reusable weekly appointment windows / slots -> create_slotbooking_option
 *
 * @package    bookingextension_agent
 * @copyright  2026 Wunderbyte GmbH <info@wunderbyte.at>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class route_create_slotbooking_de extends abstract_routing_scenario {
    /**
    ...
    public function get_key(): string {
        return 'route_create_slotbooking_de';
    }
    ...
    public function get_description(): string {
        return 'Reusable weekly appointment windows / slots -> create_slotbooking_option';
    }
