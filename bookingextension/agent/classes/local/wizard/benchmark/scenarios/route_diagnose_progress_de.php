...
/**
 * Routing scenario: Not COMPLETED / unmet completion -> diagnose_progress
 *
 * @package    bookingextension_agent
 * @copyright  2026 Wunderbyte GmbH <info@wunderbyte.at>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class route_diagnose_progress_de extends abstract_routing_scenario {
    /**
    ...
    public function get_key(): string {
        return 'route_diagnose_progress_de';
    }
    ...
    public function get_description(): string {
        return 'Not COMPLETED / unmet completion -> diagnose_progress';
    }
    ...
    public function get_user_message(): string {
        return 'Warum hat Maria den Kurs "Biologie 101" noch nicht abgeschlossen? Welche Aktivitaeten fehlen noch?';
    }
