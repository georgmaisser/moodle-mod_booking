...
class core_delete_calendar_event_task extends core_task_base implements task_trigger_provider_interface {
    ...
    public function validate(array $input, int $cmid): array {
        ...
        if (empty($input['confirmed'])) {
            $issues[] = ['code' => 'CONFIRMATION_REQUIRED', 'severity' => 'needs_confirmation', 'user_question' => get_string('agent_booking_core_confirm_delete_calendar_event', 'mod_booking'), 'remedy_options' => ['CONFIRM', 'CANCEL']];
        }
