...
- Folder: `/var/www/moodle/public/mod/booking/tests/agent/real_llm/`
...
```bash
cd /var/www/moodle
./vendor/bin/phpunit -c phpunit.xml public/mod/booking/tests/agent/real_llm/create_option_real_llm_test.php
```
